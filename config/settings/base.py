...
MIGRATION_MODULES = {"sites": "overseer.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "overseer.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# Your stuff...
# ------------------------------------------------------------------------------
ADMIN_TOOLS_MENU = "overseer.admin.menu.OverseerMenu"
ADMIN_TOOLS_INDEX_DASHBOARD = "overseer.admin.dashboard.OverseerIndexDashboard"
